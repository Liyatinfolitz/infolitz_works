"""
Django settings for firebase_auth_django project.
...
SECRET_KEY = 'django-insecure-hysk%t4v1i4z&=pg2e+^s)&zw&q!ssrdit02o5#!ijp8%rt#1b'
...
# Path to your service account key file (the JSON file you downloaded)
...
ROOT_URLCONF = 'firebase_auth_django.urls'
...
WSGI_APPLICATION = 'firebase_auth_django.wsgi.application'
